...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=aecff120ea6c43acaf6627bb7cdd1ad5&page=${this.state.page}&pageSize=${this.props.pagesize}`;
